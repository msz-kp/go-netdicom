...
func decodeCMoveRsp(d *messageDecoder) *CMoveRsp {
	...
	v.MessageIDBeingRespondedTo = d.getUInt16(dicomtag.MessageIDBeingRespondedTo, requiredElement)
	v.CommandDataSetType = d.getUInt16(dicomtag.CommandDataSetType, requiredElement)
	v.NumberOfRemainingSuboperations = d.getNonConformantUInt16(dicomtag.NumberOfRemainingSuboperations, optionalElement)
	v.NumberOfCompletedSuboperations = d.getNonConformantUInt16(dicomtag.NumberOfCompletedSuboperations, optionalElement)
	v.NumberOfFailedSuboperations = d.getNonConformantUInt16(dicomtag.NumberOfFailedSuboperations, optionalElement)
	v.NumberOfWarningSuboperations = d.getNonConformantUInt16(dicomtag.NumberOfWarningSuboperations, optionalElement)
	v.Status = d.getStatus()
	v.Extra = d.unparsedElements()
	return v
}
